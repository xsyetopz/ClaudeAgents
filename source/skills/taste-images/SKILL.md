# openagentlayer Taste Mapping: taste-images

Recommended routing: `oabtw-codex taste-images "<frontend task>"`. Uses upstream `image-to-code` content from Leonxlnx/taste-skill under the local openagentlayer name `taste-images`.

Local name: `taste-images`
Upstream name: `image-to-code`
Upstream path: `skills/image-to-code-skill/SKILL.md`
