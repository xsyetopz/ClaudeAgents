# openagentlayer Taste Mapping: taste-gpt

Recommended routing: `oabtw-codex taste-gpt "<frontend task>"`. Uses upstream `gpt-taste` content from Leonxlnx/taste-skill under the local openagentlayer name `taste-gpt`.

Local name: `taste-gpt`
Upstream name: `gpt-taste`
Upstream path: `skills/gpt-tasteskill/SKILL.md`
