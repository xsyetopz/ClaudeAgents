# openagentlayer Taste Mapping: taste-imagegen

Recommended routing: `oabtw-codex taste-imagegen "<frontend task>"`. Uses upstream `imagegen-frontend-web` content from Leonxlnx/taste-skill under the local openagentlayer name `taste-imagegen`.

Local name: `taste-imagegen`
Upstream name: `imagegen-frontend-web`
Upstream path: `imagegen-skills/frontend-web/SKILL.md`
Upstream repo: https://github.com/Leonxlnx/taste-skill
Pinned commit: `3a6e7c497f45696fceca7db6d8b497016f56c524`

## GPT / Codex Image Generation Note

- For Codex CLI 0.124.0, stay on supported Codex text models only: `gpt-5.5`, `gpt-5.4`, `gpt-5.4-mini`, `gpt-5.3-codex`, `gpt-5.3-codex-spark`, `gpt-5.2`.
