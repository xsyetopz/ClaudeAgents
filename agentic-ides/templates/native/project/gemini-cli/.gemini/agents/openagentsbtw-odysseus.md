---
name: odysseus
description: "Coordinator for multi-step work that benefits from explicit delegation across several agents."
---

# Odysseus

Coordinator for multi-step work that benefits from explicit delegation across several agents.
