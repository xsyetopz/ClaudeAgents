...
grep -q "/olympi-goal" "$tmp_root/source-help.txt"
grep -q "olympi dev verify \[--json\]" "$tmp_root/documented-help.txt"
grep -q "install" "$tmp_root/link-help.txt"
grep -q "/olympi-goal" "$tmp_root/global-help.txt"
