import { deterministicDigest, sortStrings } from "../reports/schema";
import { dangerousCommandReasons } from "./dangerous-command";
import {
	generatedArtifactReasons,
	protectedPathReasons,
} from "./protected-paths";
import { redactPolicySecrets } from "./secrets";
import type {
	HookPolicyStatus,
	PolicyDecision,
	PolicyEvent,
