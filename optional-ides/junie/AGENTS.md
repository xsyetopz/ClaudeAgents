# openagentsbtw Junie Instructions
...
- Use JetBrains Junie native instruction/rule surfaces; openagentsbtw guidance is additive.
...
- Hook status: Junie native hook parity is unavailable; guardrails are instruction based..
