...
- Use Antigravity native instruction/rule surfaces; openagentsbtw guidance is additive.
...
- Hook status: UNKNOWN official hook surface; no hook files are generated until official docs define one..
