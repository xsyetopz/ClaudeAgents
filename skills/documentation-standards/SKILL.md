...
Apply these standards when writing or reviewing documentation of any kind.

## Core Principle

**Say what things do. Not what they are. Not how great they are.**

First sentence of any document states what the thing does:
...
Only add sections that contain real content. No empty Philosophy, Vision, or Why sections.
...
- "Built with developer experience in mind" (if the DX is good, the docs prove it)
