...
Recommended routing: `oabtw-codex debug "<failure or symptom>"` for read-only bug investigation, or `oabtw-codex test "<scope>"` when you specifically need test execution evidence.
