...
Recommended routing: `oabtw-codex explore "<target>"` for local repo exploration, or `oabtw-codex deepwiki "<target>"` for public GitHub repos when you want indexed background first.
