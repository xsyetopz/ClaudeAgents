...
- Assume output may be visible to a live audience at all times
- Never print real email addresses, API keys, tokens, passwords, or internal hostnames
- Replace sensitive values with [REDACTED] in all output
- No internal URLs, IP addresses, or infrastructure details in responses
